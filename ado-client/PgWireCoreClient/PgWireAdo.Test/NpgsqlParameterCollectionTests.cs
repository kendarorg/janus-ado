...
public class NpgsqlParameterCollectionTests
{
    ...
    public void Hash_lookup_parameter_rename_bug()
    {
        ...
        {
            command.Parameters.AddWithValue(string.Format("p{0:00}", i + 1), NpgsqlDbType.String, string.Format("String parameter value {0}", i + 1));
        }
    ...
    public void Remove_duplicate_parameter([Values(LookupThreshold, LookupThreshold - 2)] int count)
    {
        ...
        {
            command.Parameters.AddWithValue(string.Format("p{0:00}", i + 1), NpgsqlDbType.String,
        ...
        command.Parameters.AddWithValue("P02", NpgsqlDbType.String, "String parameter value 2");
    ...
    public void Correct_index_returned_for_duplicate_ParameterName([Values(LookupThreshold, LookupThreshold - 2)] int count)
    {
        ...
        for (var i = 0; i < count; i++)
        {
            command.Parameters.AddWithValue(string.Format("parameter{0:00}", i + 1), NpgsqlDbType.String, string.Format("String parameter value {0}", i + 1));
        }
        ...
        command.Parameters.AddWithValue("Parameter02", NpgsqlDbType.String, "String parameter value 2");

        // Insert another case insensitive before the original.
        command.Parameters.Insert(0, new NpgsqlParameter("ParameteR02", NpgsqlDbType.String) { Value = "String parameter value 2" });
    ...
    public void IndexOf_prefers_case_sensitive_match([Values] bool manyParams)
    {
        ...
        Assert.That(parameters.IndexOf("foo"), Is.EqualTo(0));
    }
